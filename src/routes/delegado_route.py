...
async def get_usuario(usuario: DelegadoUpdate = Depends(Mid_uppercase_dependency(DelegadoUpdate)), conn:AsyncConnectionPool = Depends(object_postgres.get_connection)):
