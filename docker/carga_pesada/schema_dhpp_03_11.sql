...
COPY public.inquerito (inquerito_id, n_sinesp, n_ip, tipo_ip, data_instauracao, data_ocorrencia, fk_escrivao, fk_cartorio, fk_endereco, tipo_portaria, tipificacao, fk_equipe, periodo_ocorrencia) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.endereco_endereco_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.inquerito_inquerito_id_seq', 2, true);
