...
(
    ...
    CONSTRAINT envolvidos_inquerito_pkey PRIMARY KEY ("id ")
);
...
ALTER TABLE IF EXISTS public.envolvidos_inquerito
    ...
    REFERENCES public.suspeito (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS public.envolvidos_inquerito
    ...
    REFERENCES public.vitima (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS public.inquerito
    ...
    REFERENCES public.escrivao (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE
    NOT VALID;
